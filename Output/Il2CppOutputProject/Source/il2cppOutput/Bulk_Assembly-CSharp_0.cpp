...
// DataManager
struct DataManager_t3579773774;
// System.Byte[]
...
extern String_t* _stringLiteral2290327357;
extern String_t* _stringLiteral2491138634;
extern String_t* _stringLiteral300245797;
extern const RuntimeMethod* GameObject_GetComponent_TisText_t1901882714_m2114913816_RuntimeMethod_var;
extern const uint32_t DataManager_Start_m1389235849_MetadataUsageId;
...
#ifndef DATAMANAGER_T3579773774_H
#define DATAMANAGER_T3579773774_H
#ifdef __clang__
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Winvalid-offsetof"
#pragma clang diagnostic ignored "-Wunused-variable"
...
// DataManager
struct  DataManager_t3579773774  : public MonoBehaviour_t3962482529
{
public:
	// System.Int32 DataManager::num
	int32_t ___num_4;

public:
	inline static int32_t get_offset_of_num_4() { return static_cast<int32_t>(offsetof(DataManager_t3579773774, ___num_4)); }
...
#pragma clang diagnostic pop
#endif
#endif // DATAMANAGER_T3579773774_H
...
extern "C" IL2CPP_METHOD_ATTR bool File_Exists_m3460442015 (RuntimeObject * __this /* static, unused */, String_t* p0, const RuntimeMethod* method);
...
extern "C" IL2CPP_METHOD_ATTR ByteU5BU5D_t4116647657* File_ReadAllBytes_m1491623256 (RuntimeObject * __this /* static, unused */, String_t* p0, const RuntimeMethod* method);
...
extern "C" IL2CPP_METHOD_ATTR void File_WriteAllBytes_m3661387954 (RuntimeObject * __this /* static, unused */, String_t* p0, ByteU5BU5D_t4116647657* p1, const RuntimeMethod* method);
...
extern "C" IL2CPP_METHOD_ATTR void DataManager_Start_m1389235849 (DataManager_t3579773774 * __this, const RuntimeMethod* method)
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
		il2cpp_codegen_initialize_method (DataManager_Start_m1389235849_MetadataUsageId);
	...
	String_t* V_1 = NULL;
	{
		...
		String_t* L_1 = String_Concat_m3937257545(NULL /*static, unused*/, L_0, _stringLiteral2290327357, /*hidden argument*/NULL);
		V_0 = L_1;
		// if (File.Exists(filePath))
		String_t* L_2 = V_0;
		bool L_3 = File_Exists_m3460442015(NULL /*static, unused*/, L_2, /*hidden argument*/NULL);
		if (!L_3)
		{
			goto IL_0035;
		}
	}
	{
		...
		String_t* L_5 = V_0;
		ByteU5BU5D_t4116647657* L_6 = File_ReadAllBytes_m1491623256(NULL /*static, unused*/, L_5, /*hidden argument*/NULL);
		NullCheck(L_4);
		String_t* L_7 = VirtFuncInvoker1< String_t*, ByteU5BU5D_t4116647657* >::Invoke(42 /* System.String System.Text.Encoding::GetString(System.Byte[]) */, L_4, L_6);
		V_1 = L_7;
		// num = Int32.Parse(text);
		String_t* L_8 = V_1;
		int32_t L_9 = Int32_Parse_m1033611559(NULL /*static, unused*/, L_8, /*hidden argument*/NULL);
		__this->set_num_4(L_9);
	}

IL_0035:
	{
		// num++;
		int32_t L_10 = __this->get_num_4();
		__this->set_num_4(((int32_t)il2cpp_codegen_add((int32_t)L_10, (int32_t)1)));
		...
		int32_t* L_13 = __this->get_address_of_num_4();
		String_t* L_14 = Int32_ToString_m141394615((int32_t*)L_13, /*hidden argument*/NULL);
		NullCheck(L_12);
		ByteU5BU5D_t4116647657* L_15 = VirtFuncInvoker1< ByteU5BU5D_t4116647657*, String_t* >::Invoke(25 /* System.Byte[] System.Text.Encoding::GetBytes(System.String) */, L_12, L_14);
		File_WriteAllBytes_m3661387954(NULL /*static, unused*/, L_11, L_15, /*hidden argument*/NULL);
		...
		int32_t L_18 = __this->get_num_4();
		int32_t L_19 = L_18;
		RuntimeObject * L_20 = Box(Int32_t2950945753_il2cpp_TypeInfo_var, &L_19);
		String_t* L_21 = String_Concat_m1715369213(NULL /*static, unused*/, _stringLiteral300245797, L_20, _stringLiteral2491138634, /*hidden argument*/NULL);
		NullCheck(L_17);
...
extern "C" IL2CPP_METHOD_ATTR void DataManager__ctor_m2554816237 (DataManager_t3579773774 * __this, const RuntimeMethod* method)
{
	{
